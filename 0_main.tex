...
\newcommand{\smuscore}{\underline{\hspace{1mm}}}
...
Nel Capitolo ``Implementazione'' (Capitolo~\ref{section:progettazione}) si 
...
\input{2_implementazione}
\input{3_risultati.tex}
\input{4_conclusioni.tex}

%\newpage

\input{5_bibliografia.tex}
